...
const FloatingAIChat = () => {
  ...
  return (
    <>
      ...
      <div className="fixed bottom-6 right-6 z-50">
        {!isOpen && (
          <Button
            ...
            className="w-16 h-16 rounded-full bg-gradient-to-r from-primary to-secondary hover:from-primary/90 hover:to-secondary/90 shadow-lg hover:shadow-xl transition-all animate-pulse"
            size="icon"
          >
      ...
      {/* Chat Window */}
      {isOpen && (
        <Card className="fixed bottom-6 right-6 w-96 h-[500px] z-50 shadow-2xl border-2 border-primary/20 animate-scale-in">
            ...
            <div className="border-t p-4 space-y-3">
              ...
              <div className="flex flex-wrap gap-2">
                <Button
                  variant="outline"
                  size="sm"
                  onClick={() => setMessage("Create a task for project review")}
                >
                  Create Task
                </Button>
                <Button
                  variant="outline"
                  size="sm"
                  onClick={() => setMessage("Schedule a meeting tomorrow")}
                >
                  Schedule Meeting
                </Button>
                <Button
                  variant="outline"
                  size="sm"
                  onClick={() => setMessage("Show my connections")}
                >
                  My Apps
                </Button>
              </div>
